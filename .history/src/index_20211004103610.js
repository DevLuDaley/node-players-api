...
app.post('/api/v1/nba_players', async (req, res) => {
  try {
    ...
    const newPlayer = await pool.query('INSERT INTO players (firstName, lastName, playerId, age, jersey, photo) VALUES ($1, $2, $3, $4, $5, $6)', [firstName, lastName, playerId, age, jersey, photo], (error, res) => {
      if (error) {
        throw error;
      }
