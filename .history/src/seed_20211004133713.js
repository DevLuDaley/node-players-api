...
const createPlayer = async (req, res) => {
  try {
    ...
    //   }
    // };
            const {firstName, lastName, playerId, age, jersey, photo, avgPosAge, avgLeagueAge,} = req.body;
            const newPlayer = await pool.query('INSERT INTO players (firstName, lastName, playerId, age, jersey, photo, avgPosAge, avgLeagueAge) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [firstName, lastName, playerId, age, jersey, photo, avgPosAge, avgLeagueAge], 
            (error, results) => {
                if (error) {
                    throw error;
